...
const Services = () => {
  ...
  var data = service_content[path]

  return (
    <Layout parent="Home" sub="service" subChild={path} parentURL="/" title={data['page title']}>
      <section className='container grid grid-cols-1 lg:grid-cols-4 gap-12 pt-40'>
        <div className='col-span-3'>
          <div className="overflow-hidden">
            <img className="image-zoom transition-transform duration-300 h-full w-full brightness-50" src={data['image 1']} />
            <img className="image-zoom transition-transform duration-300 h-full w-full brightness-50" src={data['image 2']} />
          </div>
