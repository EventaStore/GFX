              ...
              <div className={`text-6xl font-bold relative top-1/2 left-1/2 transform ${currentLanguage !== 'ar' ? 'translate-x-52' : '-translate-x-52'}`}>
...

                {
                  ...
                  HomeContent['section3'].map((value, index) => (
                    <div ref={elements[c].ref} key={index} className={"w-1/2 sm:w-1/3 mx-auto lg:mx-0 p-2 opacity-10 " + (elements[c++].inView ? 'animate__animated animate__zoomInDown animate__fast ' : ' opacity-0')}>
